...
import warnings
import shutil
from untils import rotate
from untils import stick
from untils import mapping3d
from untils import feature
...
def just_perturb_image(x,y,angle,backimg, sticker, opstickercv, magnification, zstore, facemask):
    w,h = backimg.size
    rt_sticker = rotate.rotate_bound_white_bg(opstickercv, angle)
    nsticker,_ = mapping3d.deformation3d(sticker,rt_sticker,magnification,zstore,x,y)
    outImage = stick.make_stick2(backimg=backimg, sticker=nsticker, x=x, y=y, factor=1)
...
if __name__ == '__main__':
    ...
    x = 35
    y = 50
    facemask = feature.make_mask(backimg)
    stickerpath = '/home/qiuchengyu/mynewproject/adv-nir_face/black_image.png'
    ...
    zstore = mapping3d.generate_zstore(backimg)
    #just_perturb_image(x,y,angle,backimg, sticker, opstickercv, magnification, zstore, facemask)

    outputimg = just_perturb_image(x,y,angle,backimg, sticker,opstickercv,magnification, zstore, facemask)
